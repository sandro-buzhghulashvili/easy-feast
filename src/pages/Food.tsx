    ...
    <div className="lg:flex lg:justify-center mb-20 mt-40">
      ...
      {addonLoader ? (
        ...
        <div className="mb-5 px-5 w-11/12 sm:w-3/4 md:w-1/2 lg:w-1/3 xl:w-1/4 mx-auto lg:m-0">
          ...
          <button
            onClick={handleOrder}
            className="mx-auto font-bold md:hover:scale-110 duration-300 text-white_color lg:text-sm w-fit flex py-2 px-7 bg-primary_orange rounded-full items-center"
          >
